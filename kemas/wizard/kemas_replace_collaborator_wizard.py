...
class kemas_replace_collaborator_wizard(osv.osv_memory):
    def on_change_collaborator_id(self, cr, uid, ids, collaborator_id, context={}):
        ...
        if collaborator_id:
            ...
            if replacements < 0:
                values['collaborator_id'] = False
                warning = {'title' : 'Error', 'message' : 'El Colaborador seleccionado ha excedido el número de reemplazos disponibles para este mes.'}
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=True, submenu=False):       
        ...
        if error:
            ...
            <form string="" version="7.0">
               ...
               <group>
                   <field name="collaborator_id" on_change="on_change_collaborator_id(collaborator_id)" context="{'event_id' : context['event_id'], 'exclude_replaceds' : True, 'show_replacements' : True, 'all_collaborators' : True}" default_focus="1" placeholder="Colaborador a reemplazarF..." options='{"no_open": True,"no_create": True}'/>
    ...
    def replace(self, cr, uid, ids, context=None):
        ...
        # Obtener la linea de reeplazo
        line_ids = event_line_obj.search(cr, uid, [('event_id', '=', event_id), ('collaborator_id', '=', replace_id)])
        vals = {
                'collaborator_id' : replace_id,
                'collaborator_replacement_id' : collaborator_id,
                'event_id' : event_id,
                'description' : this['description'],
                'event_collaborator_line_id': line_ids[0]
                }
